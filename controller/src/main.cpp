...
constexpr uint16_t sd11boot_words[256] = {
    0012701, 0177000,     // BOOTSD: mov    #COMMAND, r1
    0012702, 0177002,     //         mov     #DATA, r2
    0012711, 0000000,     //         mov     #CMDINIT, (r1)
    0012711, 0040000,     //         mov     #CMDREAD, (r1)
    0012703, 0001000,     //         mov     #PROGRAM, r3
    0011223,              // 1$:     mov     (r2), (r3)+                                 ; Read byte
    0005711,              //         tst     (r1)                                        ; error?
    0001775,              //         beq     1$
    0012701, 0001000,     //         mov     #PROGRAM, r1
    0000111,              //         jmp     @r1
};
...
void dcj11_device_init() {
    ...
    sd11boot = new boot_rom(0173000, sd11boot_words);
}
